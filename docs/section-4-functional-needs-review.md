...
**Status:** **ROADMAP COMPLETE 2026-06-12** — Units 1, 2, 3, 4-C2 implemented 2026-06-02; Unit 5 implemented 2026-06-06; Units 6 and 7 implemented 2026-06-12 (Unit 1 D1/D2 ABA-sync fixes; Unit 2 motor split + hypotonia→PT; Unit 3 clarity relabels; Unit 4 C2 OT/PT co-management line; Unit 5 academic→psychoeducational-eval auto-recommendation; Unit 6 fecal-smearing feature; Unit 7 toddler scoping). Only Unit 4-E2 (deferred, lowest value) and C4 (deferred to David) remain open. · **Reviewed:** 2026-06-02 · **Scope:** the §4 Functional Need Domains section of [`autism-ap-builder.html`](../autism-ap-builder.html) — validity/completeness of the input items in each domain, and the output text those inputs drive (needs-summary prose + therapy-rule + plan/letter text).
